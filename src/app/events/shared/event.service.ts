...
@Injectable() // nebutinas, bet gera praktika. Reikia, kai yra konstruktorius, kuris injectina service
export class EventService {
    ...
    private handleError<T>(operation = 'operation', result?: T) { // T generic type
